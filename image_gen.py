...
for idx, fname in enumerate(images):
    ...
    # save a intermediate file for report
    cv2.imwrite('./output_images/color_grad_thresh_' + fname.split('/')[-1], preprocessImage)
    ...
    # save a intermediate file for report
    cv2.imwrite('./output_images/warped_src_' + fname.split('/')[-1], src)
    cv2.imwrite('./output_images/warped_dst_' + fname.split('/')[-1], dst)
    ...
    # save a intermediate file for report
    cv2.imwrite('./output_images/warped_' + fname.split('/')[-1], cv2.flip(warped, 1))
    ...
    # save a intermediate file for report
    cv2.imwrite('./output_images/road_warped_' + fname.split('/')[-1], road_warped)
    cv2.imwrite('./output_images/road_warped_bg_' + fname.split('/')[-1], road_warped_bkg)
